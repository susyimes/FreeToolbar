...
public class FreeToolbar extends Toolbar {
    ...
    public FreeToolbar(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, android.support.v7.appcompat.R.attr.toolbarStyle);
    }

    public FreeToolbar(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
